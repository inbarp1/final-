...
def scanline_convert(polygons, i, screen, zbuffer):
    ...
    while (finished == 0):
        ...
        if (p1[1] >= p2[1] and p1[1] >= p3[1] and p2[1] >= p3[1]):
            finished = 1
    #p1 should be the highest point with p2 second and p3 third

    if (p2[1] == p3[1]): #if the triangle bas a flat base needed to fill in
        slope1 = (p1[0] - p2[0])/(p1[1] - p2[1])
        slope2 = (p1[0] - p3[0])/(p1[1] - p3[1])
        currx0 = p3[0]
        currx1 = p2[0]
        currentLine = p3[1]
        while (currentLine < p1[1]):
            draw_line(int(currx0),
                int(currentLine),
                int(p3[2]),
                int(currx1),
                int(currentLine),
        ...
        if p1[1] - p3[1] == 0:
            ...
            slope1 = (p1[0] - p3[0])/(p1[1] - p3[1])
        if p2[1] - p3[1] == 0:
            slope2 = 0
        else:
            slope2 = (p2[0] - p3[0])/(p2[1] - p3[1])
        if p1[1] - p2[1] == 0:
            slope3 = 0
        else:
            slope3 = (p1[0] - p2[0])/(p1[1] - p2[1])
        currentLine = p3[1]
        currx0 = p3[0]
        currx1 = p3[0]
        while(currentLine < p2[1]):
            draw_line(int(currx0),
                int(currentLine),
                int(p3[2]),
                int(currx1),
